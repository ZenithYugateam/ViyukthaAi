...
import { Download, TrendingUp, TrendingDown, CheckCircle2 } from "lucide-react";
      ...
      <Card className="w-full max-w-4xl max-h-[90vh] overflow-y-auto bg-card border-border">
        <div className="p-6 md:p-8 space-y-6">
          ...
          <motion.div
            ...
            className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-950/30 dark:to-purple-950/30 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mb-4"
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-lg font-semibold text-foreground">Thank You for Completing the Interview!</h3>
                <p className="text-sm text-muted-foreground">Your responses have been analyzed. Review your performance below.</p>
              </div>
            </div>
          </motion.div>
